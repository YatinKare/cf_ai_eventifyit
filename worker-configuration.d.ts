/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0d1e6eed3d3897dfad67d5bbf45efce5)
// Runtime types generated with workerd@1.20251217.0 2024-04-03 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		AI: Ai;
		EVENTIFY_WORKFLOW: Workflow<Parameters<import("./src/index").EventifyWorkflow['run']>[0]['payload']>;
	}
}
